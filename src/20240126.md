...
[<img src="https://img.youtube.com/vi/iC8eSdoyu9A/0.jpg" width="100%"/>](https://www.youtube.com/watch?v=iC8eSdoyu9A)
...
10 or one kiloTube of videos is more fun! 
...
- [Felleisen.org Site](https://felleisen.org/matthias/)}} and [Wikipedia](https://en.wikipedia.org/wiki/Matthias_Felleisen)

One is called The Little Schemer by Daniel P Friedman{{footnote:  and 
Matthias Felleisen{{footnote: .
Dan was my adviser at Indiana University for my PhD, and he was also Matthias's adviser.
You also might know Matthias from the [Racket](https://racket-lang.org/) world, so you have two experts guiding
you. 
...
Another great resource is the Structure and Interpretation of Computer
Programs by Harold Abelson and Gerald J Sussman with Julie
Sussman.  this is very famous as maybe the
2:44
greatest textbook in the history of computer science was used as the introductory textbook at MIT for many
2:52
years it has all sorts of interesting ideas about computation and interpreters
2:57
how to write interpreters interpreters how you write a program that interprets another program those sorts of ideas
3:04
computational models great book full of deep fascinating ideas once again not a
3:11
manual on scheme scheme is introduced as needed as a computational notation which
3:17
really gets back to the heart of lisp the lisp family of languages you you
3:23
...
3:40
scheme there's a series of videos based on the ideas in the books called the
3:46
sicp lectures and if you're interested in the book you
3:53
might like these videos I will say that the videos can be in the book can be a
3:59
little mathy especially in terms of the examples um you know they aim towards
4:05
the MIT you know entering class or you know in this case um for these lectures I
4:14
don't know if these are supposed to be more experienced programmers or or whatever but um you know it can turn
4:21
people off a little bit so if you find that this is a little Hardo maybe start
4:27
with something like the little schemer first which is really written for the bright high school student but the ideas
4:33
are very deep and powerful and can you know can benefit anyone U so maybe start with something
4:39
like the little schemer and if you feel that's not enough you could try the reason schemer which is a much harder
4:46
book um but in any case you could build yourself up towards the ideas in sicp
4:52
over time
...
<!--
there's a followon book intellectually a followon book called
4:59
software designed for flexibility how to avoid programming yourself into a corner by Chris Hansen and Gerald J susman this
5:06
is metaphorically the advanced version or the advanced followup of structure
5:11
interpretation computer programs is really about how do you write software how do
5:18
you write complicated programs in such a way that if you want to make a significant change to the program you don't have to throw away all your code
5:25
...
5:37
developed over a long period of time to make software more flexible okay
5:44
so it's full of really interesting techniques should probably talk about that at some
5:49
...
6:01
book if you want something maybe closer to a
6:06
traditional textbook there's simply scheme by Brian Harvey and Matthew
6:11
Wright now you could see the second edition is from 1999 so it's you know quarter of a
6:18
century old scheme has changed so forth but the basic ideas
6:24
will be similar so there there are some other introductory textbooks on scheme
6:29
you find most of them are kind of out of date in terms of the specific language features but the important thing is how
6:37
you think about the language you can learn about the new um variants of
6:43
scheme over time there are also a bunch of papers
6:49
that you can you can find on scheme there's a scheme and functional programming Workshop it's been held for
6:56
a number of years you 2000 um hopefully there'll be a 2024 one happening soon
7:03
I'm on the steering committee for this workshop and I've organized it uh several times so if you look at one of
7:11
these workshops like from last year you can find the program and the accepted
7:18
papers and you know this sort of thing you know so here's a pre-print and you
7:25
find this is a recorded talk on um designing a language for learning
7:31
continuations you can find the video online you know lots of lots of good
7:37
resources there you know this is going to be more advanced of course than a
7:42
textbook but this is where a lot of the ideas get percolated or or more like
7:49
disseminated through the community is through papers or researchers talking to
7:56
each other if you don't have access to researchers talking to each other if you're not in grad school if you're not a working academic if you're not a
8:04
scheme implementer then reading papers is probably the best thing to do
8:11
certainly one of the best things to do now because of the internet and the web there are lots and lots of videos you
8:16
can watch and learn things that way as well and of course communicate with people via forums
8:22
and all the amazing things that we have now U speaking of forums you know
8:28
there's Lambda the ultimate the programming languages web log which used to be
8:34
more active I don't know to what extent is active these days but there's a
8:39
...
8:52
and you so Lambda the ultimate imperative for example uh I don't know what will happen
9:00
if I try opening that let's see how about that one yeah let's try
9:08
it I have no idea oh okay well anyway these are
9:14
papers with gu steel and Jerry susman these the original Lambda the ultimate papers Lambda the ultimate X these are
9:22
papers that were describing scheme and using scheme or using lisp to solve
9:27
different types of problems and looking at list per scheme from different perspectives so these are classic papers
9:34
introduction Lambda calculus okay go-to statement considered harmful by dyra
9:39
whole bunch of interesting papers essence of compiling continuations so you know these are uh classic papers in
9:47
functional programming in programming languages that are worth taking a look at and many of these are involving
9:54
scheme or some version of list
9:59
there's also this scheme. org website there at least used to be a website called read scheme I don't know if that
10:06
still exist but you know scheme's been around long enough that websites come
10:11
and go the scheme. org website seems to have lots of lots of useful
10:17
resources uh and you can see that there are different standards and implementations so forth great things
10:25
about Community books
10:30
here is a scheme bibliography on GitHub and this lists all sorts of uh Lambda
10:39
papers and papers on Macros well maybe it
10:48
doesn't fail what's going on here I don't know like I said scheme's been
10:54
around a long time so I don't know why these things aren't working see does that open okay here we go maybe it's was
10:59
just a bad link maybe it's just a bad link so you know there are lots and lots
11:06
of papers on different topics like reflection you know a bunch of really
11:11
interesting papers on reflection and scheme um we'll talk about those
11:18
too all right another way if you really want to learn scheme is to start looking
11:23
at the standards like R5 RS that's the revised revised Revis Revis Revis
11:32
report on the algorithmic language scheme so there's this tradition of
11:38
having revised repeated a bunch of times so R6 RS add one more Revis at the
11:44
beginning so be revised to the sixth power R7 RS which is standards currently being developed has revised to the
11:52
seventh power so that's if you hear people talk about R R5 R RS R six r s
11:59
they might just call it R six they're talking about different versions of the scheme specification
12:06
standard um R5 RS was the standard that was in place when I started uh graduate
12:13
school and when I started studying scheme in a serious way normally you
12:18
hear about people talking about R4 RS R5 RS R6 RS R7 RS our 7 RS is broken into
12:25
two parts a large and a small but those are the standard things you hear
12:31
about so if someone's talking about R5 RS scheme that's what they're referring to they're referring to that version of
12:37
scheme and you can get the report which is pretty short it's 50 pages long this
12:43
is a beautiful document the R5 document oh I love it one of my favorite
12:49
documents in computation and you know it has an index it
12:55
has a denotational semantics which has some problems um but you know it
13:01
contains a complete semantics for the programming language and an
13:06
index and descriptions of the core features of language and the syntax and all that and examples and the whole
13:14
thing's 50 pages long so you can read 50 pages it's not that long there'll be things you don't understand but there'll
13:20
be lots of things you do understand because this written actually very well and if you you know take a scheme
13:26
...
13:37
document more recently there's the revised revised revised revised revised
13:44
revised I think I got that right report on the algorithmic language scheme revised to the six power or
13:50
r6rs and you can find on R6 rs.
13:56
org um different versions of the specification now for R six they broke
14:03
up the specification into both the language
14:08
specification and the standard libraries so this is a bigger version of scheme
14:13
significantly bigger than RS R5 RS it's somewhat controversial that it was so
14:19
big now compared to a language like Java it's tiny but it's still much bigger
14:27
...
14:40
practical language for everyday programming practical tasks they want a bigger language R six you know they
14:47
found something of a middle ground that didn't make everyone happy maybe it made
14:52
no one happy but that was the approach taken for our six and so they broke the standard libraries into a different
14:59
...
15:09
discussion about why they did certain things okay so not only is there a a
15:15
...
15:28
interesting um now you know if you want to you know
15:33
get your hands on a specification and understand it what I probably would recommend is starting with R5 Just
15:40
because it's so small R5 RS doesn't really describe things like hygienic
15:45
macros in a lot of depth and there are some things that you know are frankly
15:51
mistakes in or or oversights in the spec so I wouldn't say
15:57
...
16:08
looks like or you could just dive into R six um but just be aware that the this
16:15
is a bigger language and and specifies a lot more and you know this libraries
16:21
part is large as well so um okay and then there's an r s which I was talking
16:29
about which is still being developed there's a small language and a large
16:34
language so like I said there was some controversy over R6 RS because it was a
16:39
bigger standard than R5 and yet it didn't include things like threads
16:46
didn't include lots of information about dealing with the operating system and you know the web so uh people who wanted
16:54
to use scheme as a a teaching language or as a language where they could easily
17:01
hack up an implementation and play around with ideas that way some of those people weren't so happy with r six
17:08
because it was bigger and complicated more complicated than R5 harder to implement harder to teach and at the
17:15
same time people who want to do web programming let's say uh or create a video game and scheme and interact with
17:22
Graphics or whatever uh complicated thing they wanted to do they weren't happy because R6 RS didn't specify that
17:31
but what R6 RS did specify was a library system where people could at least in
17:38
theory write code that could be uh modularized and maybe ported between
17:44
different implementations before R6 RS there really wasn't a chance to port code easily between scheme
17:51
implementations so R six was a step in that direction and r s it's a reaction
17:57
to some extent I think against R six where they say okay let's have a small language for the people who want a tiny
18:04
Jewel like Gem of a language that's easy to implement easy to understand they can
18:12
hack it to their heart's contempt for uh you know programming languages research or whatever they want to do they can
18:18
have the small language and for the people who want to have a really big language they have the big language so
18:25
they split up the spec which is interesting idea what's happened in practice is that
18:32
the small language design was completed in 2013 the large language design is
18:38
still going on so 11 years after the small um language was finished and I
18:44
guess this was sort of a you know almost a guaranteed outcome when you're trying
18:50
to make a much bigger version of the language um that's not supported by a
18:56
bunch of Industry you know and and government research Labs or whatever
19:04
so um this this spec is still going on you will see for any individual scheme
19:12
implementation it's likely to say which version of the spec is supported they support R4 RS they support R5 R six R7
19:20
R7 small nothing supports R7 large completely because that spec is still
19:26
being developed scheme um currently supports R6
19:32
RS uh and even for something like R6 RS or R5 RS you'll often see that an
19:40
individual specification or sorry individual implementation will describe differences
19:46
from the spec so in fact for some versions of the specification the the
19:52
specification itself is internally inconsistent and it's impossible to implement
19:58
a a correct version or at least people have made that argument that it's impossible to create a fully conforming
20:06
implementation um also there are some subtleties in the spec that you know
20:12
make a little bit of a design and implementation tradeoff to decide to
20:18
implement every single thing in the spec so many implementations will say they're
20:23
they Implement R NRS whatever n is um modulo this one little feature what have
20:31
you okay so those are the the language specs and it's really important if
20:37
you're going to use scheme or any other language to be comfortable with the
20:43
definition of the language I think nice thing about scheme is this the the specification is actually pretty
20:50
small if you want to learn C++ or Java those specifications are quite
20:56
complicated although C++ they seem to be um maybe simplifying uh Java still seems to be
21:04
getting more complicated in a way although they are adding abstractions that hopefully are
21:10
helpful okay another way to learn about scheme is to read this book this is a
21:17
